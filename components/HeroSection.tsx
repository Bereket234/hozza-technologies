        ...
        <div className="relative h-[500px] lg:h-[600px] flex items-center justify-center lg:z-10 group">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <p className="text-[10px] font-bold text-zinc-900 tracking-tight">Alex Thompson</p>
                <p className="text-[8px] text-zinc-400 font-bold uppercase tracking-wider">CEO, FinTech Startup</p>
              </div>
            </div>
